...
const hi: BeatUIMessages = {
  ...
  dataTable: {
    ...
    // Filter panel
    filterPanelAddCondition: 'शर्त जोड़ें',
    filterPanelApply: 'लागू करें',
    filterPanelClear: 'फ़िल्टर साफ़ करें',
    filterPanelAnd: 'और',
    filterPanelOr: 'या',
    filterPanelContains: 'शामिल है',
    filterPanelNotContains: 'शामिल नहीं है',
    filterPanelEquals: 'बराबर है',
    filterPanelNotEquals: 'बराबर नहीं है',
    filterPanelStartsWith: 'से शुरू होता है',
    filterPanelEndsWith: 'से समाप्त होता है',
    filterPanelIsNull: 'खाली है',
    filterPanelIsNotNull: 'खाली नहीं है',
    filterPanelGt: 'से अधिक',
    filterPanelGte: 'से अधिक या बराबर',
    filterPanelLt: 'से कम',
    filterPanelLte: 'से कम या बराबर',
    filterPanelBetween: 'के बीच',
    filterPanelValuePlaceholder: 'मान...',
    ...
    describeFilter: {
      ...
      textEndsWith: (col: string, val: string) => `${col} अंत "${val}" से`,
      ...
      setNotIn: (col: string, vals: string) => `${col} [${vals}] में नहीं`,
      booleanIs: (col: string, val: string) => `${col} है ${val}`,
      isNull: (col: string) => `${col} खाली है`,
      isNotNull: (col: string) => `${col} खाली नहीं है`,
      compositeAnd: (descriptions: string[]) => descriptions.join(' और '),
      compositeOr: (descriptions: string[]) => descriptions.join(' या '),
    },
  },
  prosemirror: {
    bold: 'Bold',
