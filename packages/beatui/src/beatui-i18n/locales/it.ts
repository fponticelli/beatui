...
const it: BeatUIMessages = {
  ...
  paginationRange: (
    ...
    total > filtered
      ? `Righe da ${from} a ${to} di ${filtered} di ${total}`
      : `Righe da ${from} a ${to} di ${filtered}`,
  ...
  timePicker: {
    ...
    selectSeconds: 'Seleziona secondi',
    selectPeriod: 'Seleziona AM/PM',
    nowLabel: 'Adesso',
  },
  // Time select
  ...
  transferList: {
    ...
    searchAvailable: 'Cerca elementi disponibili…',
    searchSelected: 'Cerca elementi selezionati…',
  },
  // Copy button
  copyButton: {
    copied: 'Copiato!',
