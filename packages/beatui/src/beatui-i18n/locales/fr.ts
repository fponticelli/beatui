...
const fr: BeatUIMessages = {
  ...
  timePicker: {
    ...
    selectSeconds: 'Sélectionner les secondes',
    selectPeriod: 'Sélectionner AM/PM',
    nowLabel: 'Maintenant',
  },
  // Time select
  ...
  transferList: {
    ...
    searchAvailable: 'Rechercher les éléments disponibles…',
    searchSelected: 'Rechercher les éléments sélectionnés…',
  },
  // Copy button
  copyButton: {
    copied: 'Copié !',
