  ...
  return WidgetPage({
    ...
    body: html.div(
      ...
      SectionStack(
        ...
        html.div(
          attr.class('flex items-center gap-2'),
          html.span(attr.class('text-sm w-36'), 'Copy:'),
          Kbd({}, 'Ctrl'),
          html.span('+'),
          Kbd({}, 'C')
        ),
        html.div(
          attr.class('flex items-center gap-2'),
          html.span(attr.class('text-sm w-36'), 'Paste:'),
          Kbd({}, 'Ctrl'),
          html.span('+'),
          Kbd({}, 'V')
        ),
        html.div(
          attr.class('flex items-center gap-2'),
          html.span(attr.class('text-sm w-36'), 'Save:'),
          Kbd({}, 'Ctrl'),
          html.span('+'),
          Kbd({}, 'S')
        ),
        html.div(
          attr.class('flex items-center gap-2'),
          html.span(attr.class('text-sm w-36'), 'Undo:'),
          Kbd({}, 'Ctrl'),
          html.span('+'),
          Kbd({}, 'Z')
        ),
        html.div(
          attr.class('flex items-center gap-2'),
          html.span(attr.class('text-sm w-36'), 'Redo:'),
          Kbd({}, 'Ctrl'),
          html.span('+'),
          Kbd({}, 'Shift'),
          html.span('+'),
        ...
        html.div(
          attr.class('flex items-center gap-2'),
          html.span(attr.class('text-sm w-36'), 'Command Palette:'),
          Kbd({}, '⌘'),
          html.span('+'),
          Kbd({}, 'K')
        )
