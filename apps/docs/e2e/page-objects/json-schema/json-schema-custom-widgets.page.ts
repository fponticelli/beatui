...
/**
 * Page object for the JSON Schema Custom Widgets page
 */
export class JSONSchemaCustomWidgetsPage extends BasePage {
  ...
  constructor(page: Page) {
    super(page, '/json-schema-custom-widgets')
  ...
  async checkComponentAccessibility() {
    return this.checkAccessibility({
      exclude: getExclusionsForComponent('json-schema-custom-widgets'),
    })
  }
}
