...
/**
 * Page object for the JSON Structure Form page
 */
export class JSONStructureFormPage extends BasePage {
  ...
  constructor(page: Page) {
    super(page, '/json-structure-form')
  ...
  async checkComponentAccessibility() {
    return this.checkAccessibility({
      exclude: getExclusionsForComponent('json-structure-form'),
    })
  }
}
