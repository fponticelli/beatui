...
stat1 = StatCard({value: "Revenue", label: "$48,200", trendDirection: "up"})
stat2 = StatCard({value: "Active Users", label: "3,891", trendDirection: "up"})
stat3 = StatCard({value: "Churn Rate", label: "2.4%", trendDirection: "down"})
divider = Divider()
