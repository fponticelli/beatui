    ...
    Group(
          ...
          Flyout({
            content: () =>
              Fragment(
                ...
                html.div(
                  attr.class('p-4'),
                  html.div(attr.class('font-semibold text-center'), '🎉 Custom Trigger!'),
                  html.p(
                    attr.class('mt-2'),
      ...
      html.div(
        ...
        html.div(
          ...
          html.div(
            attr.class('flex items-center justify-center text-sm text-gray-400'),
            'Center'
          ),
          Button(
            { variant: 'light', size: 'sm' },
              ...
              Fragment(
                ...
                html.div(
                 ...
                 html.div(
                  ...
                  html.div(
                    attr.class('text-xs text-gray-500 mt-3 pt-3 border-t'),
                    computedOf(
                      showDelay,
                      hideDelay,
                      closable
