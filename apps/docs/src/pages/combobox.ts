...
export const ComboboxPage = () => {
  ...
  return ScrollablePanel({
    body: Stack(
      ...
      // Page title
      html.h1(
        attr.class('bu-text-3xl bu-font-bold bu-text--gray-900'),
        'Combobox Component'
      ),

      html.p(
        attr.class('bu-text-lg bu-text--gray-600'),
      ...
      Stack(
        attr.class('bu-gap-4'),
        html.h2(
          attr.class('bu-text-2xl bu-font-semibold bu-text--gray-800'),
          'Basic Usage'
        ),
        html.p(
        ...
        Group(
          ...
          Stack(
            ...
            style.width('16rem'),
            html.label(
              attr.class('bu-text-sm bu-font-medium bu-text--gray-700'),
              'Select a fruit:'
            ),
            Combobox({
              value: basicValue,
          ...
          html.div(
            attr.class('bu-text-sm bu-text--gray-500'),
            'Selected: ',
      ...
      Stack(
        ...
        html.ul(
          attr.class(
            'bu-list-disc bu-list-inside bu-text--gray-600 bu-space-y-2'
          ),
      ...
      Stack(
        ...
        html.div(
          ...
          html.div(
            ...
            html.ul(
              attr.class('bu-space-y-1 bu-text--gray-600'),
